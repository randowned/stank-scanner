...
- **Maphra (media analytics):** [src/stankbot/services/media_service.py](src/stankbot/services/media_service.py) (guild-scoped CRUD + refresh + history) + [media_providers/](src/stankbot/services/media_providers/) (`base.py`, `registry.py`, `youtube.py`, `spotify.py`, `mock_providers.py` for `dev-mock`) + [cogs/media_commands.py](src/stankbot/cogs/media_commands.py) (`/media youtube info` / `/media spotify info`) + [scheduling/media_metrics_scheduler.py](src/stankbot/scheduling/media_metrics_scheduler.py) (clock-aligned per-guild interval refresh, default 60 min, floor 5 min) + [web/routes/media_api.py](src/stankbot/web/routes/media_api.py) + [media_admin.py](src/stankbot/web/routes/media_admin.py) + [mock_media.py](src/stankbot/web/routes/mock_media.py) + frontend [routes/media/](src/stankbot/web/frontend/src/routes/media/) and [routes/admin/media/](src/stankbot/web/frontend/src/routes/admin/media/).
